...
def run_train_initial_model(reference_date=None):
    ...
    # Features
    contract_features = compute_contract_features(df_contract, df_payment, df_lkp, reference_date)
    ...
    version = register_model(CHAMPION_MODEL_PATH, metadata, role="champion")
