...
export default function ProgressBar({ value, tone = 'primary', trackClassName = '' }: ProgressBarProps) {
  return (
    <div className={`w-full h-1.5 rounded-full bg-surface-container-high dark:bg-surface-variant/30 overflow-hidden ${trackClassName}`}>
      <div
